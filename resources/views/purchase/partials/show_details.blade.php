<div class="modal-header">
  ...
  <div class="row invoice-info">
    ...
    <div class="col-sm-4 invoice-col">
      ...
      <b>Currency:</b> {{ $purchase->selected_currency }}<br>
      <b>Exchange Rate:</b> Rs {!! number_format($purchase->exchange_rate, 2) !!}<br>
    </div>
  </div>
        ...
        <table class="table bg-gray">
          <thead>
            <tr class="bg-green">
              ...
              <th class="text-right">QC Pass Quantity</th>
          ...
          @foreach($purchase->purchase_lines as $purchase_line)
            <tr>
              ...
              <td><span class="display_currency" data-is_quantity="true" data-currency_symbol="false">{{ $purchase_line->qc_qty }}</span> @if(!empty($purchase_line->sub_unit)) {{$purchase_line->sub_unit->short_name}} @else {{$purchase_line->product->unit->short_name}} @endif</td>
  ...
  <div class="row">
    <div class="col-sm-12 col-xs-12">
      <b>Purchased Serials:</b> # @foreach($purchase->purchase_lines as $purchase_line) {{ $purchase_line->serials??'N/A' }} @endforeach <br/>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-12 col-xs-12">
