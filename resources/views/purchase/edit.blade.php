@extends('layouts.app')
@section('title', __('Edit Goods Received Note'))
...
<section class="content-header">
    <h1>@lang('Edit Goods Received Note') <i class="fa fa-keyboard-o hover-q text-muted" aria-hidden="true" data-container="body" data-toggle="popover" data-placement="bottom" data-content="@include('purchase.partials.keyboard_shortcuts_details')" data-html="true" data-trigger="hover" data-original-title="" title=""></i></h1>
</section>
        ...
        <div class="row">
            ...
            <div class="col-sm-3 @if(!empty($default_purchase_status)) hide @endif">
              <div class="form-group">
                ...
                {!! Form::select('status', $orderStatuses, $purchase->status, ['class' => 'form-control select2', 'required', 'disabled']); !!}
              </div>
            </div>
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="selected" id="select_curenncy">
                            ...
                            @if ($purchase->selected_currency_symbol == $system_currency->currency_symbol)
                            <option data="{{ $system_currency->id }}" value="{{ $system_currency->currency_symbol }}" selected>
                                {{ $system_currency->currency_name . ' - ' . $system_currency->currency_symbol }}</option>
                                @else
                                <option data="{{ $system_currency->id }}" value="{{ $system_currency->currency_symbol }}">
                                    {{ $system_currency->currency_name . ' - ' . $system_currency->currency_symbol }}</option>
                                @endif
                        ...
                        <input type="hidden" name="selected_currency" id="selected_currency"
                            value="{{ $purchase->selected_currency }}">
                        <input type="hidden" name="selected_currency_symbol" id="txt_currency_symbol"
                            value="{{ $purchase->selected_currency_symbol }}">
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="exchange_rate" id="currency_rate"
                        value="{{ $purchase->exchange_rate }}">
                        @else
                        <input type="number" class="form-control" name="exchange_rate" id="currency_rate"
                        value="{{ $purchase->exchange_rate }}" readonly>
                        @endif
