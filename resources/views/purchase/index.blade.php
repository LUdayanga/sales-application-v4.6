@extends('layouts.app')
@section('title', __('Goods Received Note'))

@section('content')

    <!-- Content Header (Page header) -->
    <section class="content-header no-print">
        <h1>@lang('Goods Received Note')
            <small></small>
        </h1>
        <!-- <ol class="breadcrumb">
    ...
    <section class="content no-print">
        @component('components.filters', ['title' => __('report.filters')])
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('purchase_list_filter_status', $orderStatusesFilter, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]) !!}
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
        ...
        @component('components.widget', ['class' => 'box-primary', 'title' => __('All Goods Received Note')])
            @can('purchase.create')
                @slot('tool')
                    <div class="box-tools">
...
@section('javascript')
    ...
    <script>
        ...
        $(document).on('click', '.update_status', function(e) {
            e.preventDefault();
            if ($.trim($(this).text()) == "qc approved") {
                var ref_no = $.trim($(this).closest("tr").find('td:eq(3)').text());
