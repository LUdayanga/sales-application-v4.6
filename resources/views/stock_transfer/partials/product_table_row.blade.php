<tr class="product_row">
    ...
    <td style="display:none;>
        <input type="text" readonly class="form-control availableQty" required>
    </td>
    <td style="display:none;>
        <input type="number" class="form-control transferQty" name="" required>
    </td>
    <td style="display:none;>
        <input type="number" class="form-control qcQty" name="" id="input_qc_qty" required>
    </td>
