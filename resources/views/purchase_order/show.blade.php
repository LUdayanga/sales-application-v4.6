        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h5 style="text-align: center; margin-bottom: -8px;">Seegiriswatta, Mawathagama, Sri Lanka 60060
                    </h5>
                    <h5 style="text-align: center; margin-bottom: -10px;">Tel: +94 77 270 0003, +94 37 229 6611</h5>
                    <h5 style="text-align: center; margin-bottom: -10px;">Email: financevirco@gmail.com Web:
                        www.virco.lk</h5>
            ...
            <div class="row invoice-info">
                <div class="col-md-9 invoice-col">
                    ...
                    <h5 style="margin-bottom: -8px;">Supplier Name: <b>{!! $purchase->contact->name !!}</h5>

                    @if (!empty($purchase->contact->tax_number))
                        <h5 style="margin-bottom: -8px;">Tax No: <b>{!! $purchase->contact->tax_number !!}</h5>
                    @endif

                    @if (!empty($purchase->contact->mobile))
                        <h5 style="margin-bottom: -8px;">Mobile: <b>{!! $purchase->contact->mobile !!}</h5>
                    @endif

                    @if (!empty($purchase->contact->email))
                        <h5 style="margin-bottom: -8px;">Email: <b>{!! $purchase->contact->email !!}</h5>
                    @endif
                    ...
                    <br>
                    <h5 style="margin-bottom: -8px;">Currency: <b>{!! $purchase->selected_currency !!}</h5>
                    <h5 style="margin-bottom: -8px;">Exchange Rate: <b>Rs {!! number_format($purchase->exchange_rate, 2) !!}</h5>
                </div>
                        ...
                        <table class="table bg-gray">
                            <thead>
                                <tr class="bg-green">
                                    ...
                                    {{-- <th class="text-right">@lang('purchase.qc_quantity')</th> --}}
                            ...
                            @foreach ($purchase->purchase_lines as $purchase_line)
                                <tr>
                                    ...
                                    @if ($purchase->type == 'purchase_order')
                                        <td>
                                            @if ($purchase_line->qc_qty != '')
                                                <span class="display_currency" data-is_quantity="true"
                                                    data-currency_symbol="false">{{ $purchase_line->quantity - $purchase_line->qc_qty }}</span>
                                                @if (!empty($purchase_line->sub_unit))
                                                    {{ $purchase_line->sub_unit->short_name }}
                                                @else
                                                    {{ $purchase_line->product->unit->short_name }}
                                                @endif
                                                <br><small>(QC Fail Qty =
                                                    {{ $purchase_line->po_quantity_purchased - $purchase_line->qc_qty }})</small>
                                            @else
                                                <span class="display_currency" data-is_quantity="true"
                                    ...
                                    {{-- <td class="text-right"><span class="display_currency" data-is_quantity="true"
                                            data-currency_symbol="false">{{ $purchase_line->qc_qty }}</span>
                                        @if (!empty($purchase_line->sub_unit))
                                            {{ $purchase_line->sub_unit->short_name }}
                                        @else
                                            {{ $purchase_line->product->unit->short_name }}
                                    ...
                                    <td class="text-right"><span
                                            class="display_currency">{{ $purchase_line->discount_percent }}</span> %
                                    </td>
                                    <td class="no-print text-right"><span class="display_currency"
                                            data-currency_symbol="true">{{ $purchase_line->purchase_price }}</span>
                                    </td>
                                    <td class="no-print text-right"><span class="display_currency"
                            ...
                            @if ($purchase->type != 'purchase_order')
                                ...
                                @endphp
                                <td class="text-right"><span class="display_currency"
                                        data-currency_symbol="true">{{ $sp }}</span></td>
