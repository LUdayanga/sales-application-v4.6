...
{!! Form::open(['url' => action('ProductController@update' , [$product->id] ), 'method' => 'PUT', 'id' => 'product_add_form',
            ...
            <div class="col-sm-4">
              <div class="form-group">
                {!! Form::label('product_locations', __('business.business_locations') . ':*') !!} @show_tooltip(__('lang_v1.product_location_help'))
                  {!! Form::select('product_locations[]', $business_locations, $product->product_locations->pluck('id'), ['class' => 'form-control select2', 'multiple', 'id' => 'product_locations', 'required']); !!}
              </div>
            </div>
            ...
            <div class="col-sm-4">
              <div class="form-group">
                {!! Form::label('product_parameters', __('Product Parameters') . ':*') !!}
                  {!! Form::select('product_parameters[]', $get_all_parameters, $parameters->pluck('parameter_parent_id'), ['class' => 'form-control select2', 'multiple', 'id' => 'product_locations', 'required']); !!}
              </div>
            </div>
    ...
    <div class="col-sm-2">
      <div class="form-group">
          ...
          {!! Form::text('our_price', $product->our_price, ['class' => 'form-control']); !!}
      </div>
  </div>
  <div class="row">
