...
{!! Form::open(['url' => action('ProductController@store'), 'method' => 'post', 
    ...
    @component('components.widget', ['class' => 'box-primary'])
      ...
      <div class="clearfix"></div>
        ...
        <div class="col-sm-4 @if(!session('business.enable_category')) hide @endif">
          <div class="form-group">
            {!! Form::label('category_id', __('product.category') . ':') !!}
              {!! Form::select('category_id', $categories, !empty($duplicate_product->category_id) ? $duplicate_product->category_id : null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2', 'id' => 'category_dropdown']); !!}
          </div>
        </div>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('product_locations', __('business.business_locations') . ':*') !!} @show_tooltip(__('lang_v1.product_location_help'))
              {!! Form::select('product_locations[]', $business_locations, $default_location, ['class' => 'form-control select2', 'multiple', 'id' => 'product_locations', 'required']); !!}
          </div>
        </div>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('product_parameters', __('Product Parameters') . ':*') !!}
              {!! Form::select('product_parameters[]', $get_all_parameters, null, ['class' => 'form-control select2', 'multiple', 'id' => 'product_locations', 'required']); !!}
          </div>
        </div>
    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-sm-2">
          <div class="form-group">
              ...
              {!! Form::text('our_price', !empty($duplicate_product->our_price) ? $duplicate_product->our_price : null, ['class' => 'form-control']); !!}
          </div>
      </div>
