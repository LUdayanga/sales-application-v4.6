                ...
                <div class="col-xs-12 pos-tab-container">
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu">
                        <div class="list-group">
                            ...
                            <a href="#" class="list-group-item text-center">System Currency</a>
...
@section('javascript')
    <script type="text/javascript">
        ...
        $(document).on('click', '#add_values', function() {
            ...
            var values_table_count = $("#currency_table tbody tr").length;

                $("#tbody_currency_table").append(
                    '<tr>\
                    <td><input type="text" class="form-control" name="currency_name[]" required></td>\
                    <td><input type="text" class="form-control" name="currency_symbol[]" required></td>\
                    <td><input type="number" class="form-control" name="currency_rate[]" required></td>\
                    <td><button type="button" class="btn btn-danger delete_currency_values">-</button></td>\
                    <td hidden><input type="text" class="form-control" name="is_show_currency[]" value="1" required></td>\
                    </tr>'
                );
        });

        $(document).on('click', '.delete_currency_values', function() {
            swal({
            title: LANG.sure,
            icon: 'warning',
            buttons: true,
