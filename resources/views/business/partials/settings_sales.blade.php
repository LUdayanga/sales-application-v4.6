    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[allow_selling_below_purchase_price]', 1,  
                        !empty($pos_settings['allow_selling_below_purchase_price']) ? true : false , 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.allow_selling_below_purchase_price' ) }} 
                  </label>
                  @show_tooltip(__('lang_v1.allow_selling_below_purchase_price_help'))
                </div>
            </div>
        </div>
        <div class="col-sm-4">
