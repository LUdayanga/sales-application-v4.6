        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="@if (!empty($export_custom_fields)) col-sm-3 @else col-sm-4 @endif">
                    <b>@lang('messages.date'):</b> {{ @format_date($sell->transaction_date) }}<br>
                    <b>
                        @if ($sell->type == 'sales_order')
          ...
          @endif --}}
                    ...
                    @endif
                    <b>Currency:</b> {{ $sell->selected_currency }}<br>
              <b>Exchange Rate:</b> Rs {!! number_format($sell->exchange_rate, 2) !!}<br>
                </div>
                <div class="@if (!empty($export_custom_fields)) col-sm-3 @else col-sm-4 @endif">
