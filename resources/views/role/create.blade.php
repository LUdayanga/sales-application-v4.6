            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'product.parameters', false, ['class' => 'input-icheck']) !!} {{ __('Access Product Paramters') }}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'product_requirement.view', false, ['class' => 'input-icheck']) !!} {{ __('View Products Requirement Report') }}
                            </label>
                        </div>
                    </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'machines.view', false, ['class' => 'input-icheck']) !!} {{ __('role.machines.view') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'machines.create', false, ['class' => 'input-icheck']) !!} {{ __('role.machines.create') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'machines.update', false, ['class' => 'input-icheck']) !!} {{ __('role.machines.update') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'machines.delete', false, ['class' => 'input-icheck']) !!} {{ __('role.machines.delete') }}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'qc.view', false, ['class' => 'input-icheck']) !!} {{ __('View Quality Control') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'qc.create', false, ['class' => 'input-icheck']) !!} {{ __('Add Quality Control') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'qc.update', false, ['class' => 'input-icheck']) !!} {{ __('Edit Quality Control') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'qc.delete', false, ['class' => 'input-icheck']) !!} {{ __('Delete Quality Control') }}
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'qc.1', false, ['class' => 'input-icheck']) !!} {{ __('Create Quality Control Step 1') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'qc.2', false, ['class' => 'input-icheck']) !!} {{ __('Create Quality Control Step 2') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'qc.3', false, ['class' => 'input-icheck']) !!} {{ __('Create Quality Control Step 3') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'qc.4', false, ['class' => 'input-icheck']) !!} {{ __('Create Quality Control Step 4') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'qc.5', false, ['class' => 'input-icheck']) !!} {{ __('Create Quality Control For Production') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'qc.finalize', false, ['class' => 'input-icheck']) !!} {{ __('Finalize & Disapproved Quality Control') }}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'stores.create', false, ['class' => 'input-icheck']) !!} {{ __('Transfer product for MRN') }}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'currency_rate.edit', false, ['class' => 'input-icheck']) !!} {{ __('Edit Currency Rate In Transactions') }}
                            </label>
                        </div>
                    </div>
                </div>
