          ...
          <div class="well">
            ...
            <strong>@lang('contact.total_purchase_due'): </strong><span class="display_currency" data-currency_symbol="true">{{ $contact_details->total_purchase - $contact_details->total_paid }}</span><br>
             @if(!empty($contact_details->opening_balance) || $contact_details->opening_balance != '0.00')
                  ...
                  {{ $ob_due }}</span>
              @endif
              <strong>@lang('account.current_opening_balance'): </strong>
              <span class="display_currency" data-currency_symbol="true">
              {{ $ob_due }}</span>
        </div>
          </div>
      ...
      <div class="row payment_row">
        ...
        <div class="col-md-4">
          <div class="form-group">
            <br>
            <label>
              {!! Form::checkbox('for_opening_balance', 1, false, ['class' => 'input-icheck', 'id' => 'for_opening_balance']); !!} <strong>@lang('lang_v1.for_opening_balance')</strong>
            </label>
          </div>
        </div>
        <div class="clearfix"></div>
