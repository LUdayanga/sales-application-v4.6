  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      @if(!empty($transaction->contact))
        ...
        <div class="col-md-4">
          <div class="well">
            <strong>@lang('sale.total_amount'): </strong><span>{{ $transaction->selected_currency_symbol . ' ' . number_format(($transaction->final_total / $transaction->exchange_rate), 2) }}</span><br>
            <strong>Currency: </strong><span>{{ $transaction->selected_currency }}</span><br>
            <strong>Exchange Rate: </strong><span class="display_currency" data-currency_symbol="true">{{ $transaction->exchange_rate }}</span><br>
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::text("amount", @num_format($payment_line->amount /  $transaction->exchange_rate), ['class' => 'form-control input_number', 'required', 'placeholder' => 'Amount', 'data-rule-max-value' => @num_format($payment_line->amount), 'data-msg-max-value' => __('lang_v1.max_amount_to_be_paid_is', ['amount' => $amount_formated])]); !!}
            </div>
          </div>
        </div>
        <div class="col-md-4">
