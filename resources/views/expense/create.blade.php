...
@section('content')
    ...
    <section class="content">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="selected_currency" id="selected_currency"
                                value="{{ $default_currency_rate->currency_name }}">
                            <input type="hidden" name="selected_currency_symbol" id="txt_currency_symbol"
                                value="{{ $default_currency_rate->currency_symbol }}">
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            @if (auth()->user()->can('currency_rate.edit'))
                                <input type="number" class="form-control" name="exchange_rate" id="currency_rate"
                                    value="{{ $default_currency_rate->currency_rate }}">
                            @else
                                <input type="number" class="form-control" name="exchange_rate" id="currency_rate"
                                    value="{{ $default_currency_rate->currency_rate }}" readonly>
                            @endif
        ...
        @component('components.widget',
            ['class' => 'box-solid', 'id' => 'payment_rows_div', 'title' => __('purchase.add_payment')])
...
@section('javascript')
    <script type="text/javascript">
        ...
        function calculateExpensePaymentDue() {
            ...
            $('#payment_due').text(currency_symbol + ' ' + payment_due, true, false);
        }
