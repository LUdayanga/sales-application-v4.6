                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="selected" id="select_curenncy">
                                @foreach ($system_currencies as $system_currency)
                                    @if ($expense->selected_currency_symbol == $system_currency->currency_symbol)
                                        <option data="{{ $system_currency->id }}"
                                            value="{{ $system_currency->currency_symbol }}" selected>
                                            {{ $system_currency->currency_name . ' - ' . $system_currency->currency_symbol }}
                                        </option>
                                    @else
                                        <option data="{{ $system_currency->id }}"
                                            value="{{ $system_currency->currency_symbol }}">
                                            {{ $system_currency->currency_name . ' - ' . $system_currency->currency_symbol }}
                                        </option>
                                    @endif
                                @endforeach
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            @else
                                <input type="number" class="form-control" name="exchange_rate" id="currency_rate"
                                    value="{{ $expense->exchange_rate }}" readonly>
                            @endif
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::select('expense_for', $users, $expense->expense_for, [
                                'class' => 'form-control select2',
                                'placeholder' => __('messages.please_select'),
                            ]) !!}
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::select('contact_id', $contacts, $expense->contact_id, [
                                'class' => 'form-control select2',
                                'placeholder' => __('messages.please_select'),
                            ]) !!}
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('final_total', @num_format($expense->final_total), [
