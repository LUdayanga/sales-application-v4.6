$(document).ready(function() {
    ...
    supplier_report_tbl = $('#supplier_report_tbl').DataTable({
        ...
        fnDrawCallback: function(oSettings) {
            ...
            var total_qc_purchase = sum_table_col($('#supplier_report_tbl'), 'total_qc_purchase');
            $('#footer_total_qc_purchase').text(total_qc_purchase);
    ...
    product_purchase_report = $('table#product_purchase_report_table').DataTable({
        ...
        columns: [
            ...
            { data: 'purchase_qc_qty', name: 'purchase_lines.purchase_qc_qty' },
            { data: 'purchase_lot_number', name: 'purchase_lines.purchase_lot_number' },
            ...
            { data: 'qctotal', name: 'qctotal', searchable: false },
        ],
        fnDrawCallback: function(oSettings) {
            ...
            $('#footer_qctotal').text(
                sum_table_col($('#product_purchase_report_table'), 'row_qctotal')
            );
            $('#footer_total_purchase').html(
                __sum_stock($('#product_purchase_report_table'), 'purchase_qty')
            );
            $('#footer_total_qc_purchase').html(
                __sum_stock($('#product_purchase_report_table'), 'purchase_qc_qty')
            );
    ...
    //view product lots modal
    $(document).on("click", "#viewLotModal", function(){
