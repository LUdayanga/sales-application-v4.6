...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('home/cheque-alert', 'HomeController@getCheckAlert');
    ...
    Route::get('/products/view-product-lots/{id}', 'ProductController@viewLotGroup');
    ...
    //get currencies
    Route::post('/system-currentcies/get-details', 'PurchaseController@getCurrencies');
    ...
    Route::get('/reports/quick-requirement', 'ReportController@getQuickRequirement');
    Route::get('/reports/quick-requirement/ingredient-requirement', 'ReportController@getIngrediantRequirement');
    ...
    Route::post('/machines/update', 'MachineController@updates');

    //product parameters
    Route::resource('/product-parameters', 'ProductParameterController');
    Route::post('/product-parameters/store', 'ProductParameterController@store');

    //quality controller
    Route::resource('/quality-control', 'QualityController');
    Route::get('/quality-control/create', 'QualityController@create');
    Route::post('/quality-control/load_product', 'QualityController@load_product');
    Route::post('/quality-control/load_parameters', 'QualityController@load_parameters');
    Route::post('/quality-control/tempory_save_parameters', 'QualityController@tempory_save_parameters');
    Route::post('/quality-control/delete_tempory_parameters', 'QualityController@delete_tempory_parameters');
    Route::post('/quality-control/update_product_parameters', 'QualityController@update_product_parameters');
    Route::post('/quality-control/view_quality_product_parameters', 'QualityController@view_parameters');
    Route::post('/quality-control/save_deatils', 'QualityController@save_deatils');
    Route::post('/quality-control/view_qc_deatils', 'QualityController@view_qc_deatils');
    Route::post('/quality-control/update_deatils', 'QualityController@update_deatils');
    Route::post('/quality-control/load_edit_modal', 'QualityController@load_edit_modal');
    Route::get('/quality-control/search_product', 'QualityController@search_product');
    Route::post('/quality-control/delete_record', 'QualityController@delete_record');

    //stores for mrn
    Route::resource('/stores', 'StoresController');
    Route::post('/StoresController/load_ingrediants', 'StoresController@load_ingrediants');
    Route::post('/StoresController/save_details', 'StoresController@save_details');
...
//        bulk payment
    ...
    Route::get('/sales-order/edit-shipping/{id}', 'SellController@editShipping');
