...
class ProductUtil extends Util
{
    ...
    public function updateProductQuantity($location_id, $product_id, $variation_id, $new_quantity, $old_quantity = 0, $number_format = null, $uf_data = true)
    {
        ...
        if ($product->enable_stock == 1 && $qty_difference != 0) {
            ...
            $variation_location_d->lot_number = 'fdgfg';
     ...
     * @return array
     */
    public function getDetailsFromVariation($variation_id, $business_id, $location_id = null, $check_qty = true, $is_sales_order)
    {
    ...
    public function createOrUpdatePurchaseLines($transaction, $input_data, $currency_details, $enable_product_editing, $before_status = null)
    {
        ...
        foreach ($input_data as $data) { 
            ...
            $new_quantity = $this->num_uf($data['qc_quantity']) * $multiplier;
            ...
            $purchase_line->quantity = $data['quantity'];
            // $purchase_line->qc_qty = 0;
            ...
            if (isset($data['is_qc4_checked'])) {
                $purchase_line->is_qc4_checked = $data['is_qc4_checked'];
            } else {
                $purchase_line->is_qc4_checked = '';
            }
