...
class Util
{
    ...
    */
    ...
    public function PurchaseorderStatuses()
    {
        return [ 'received' => __('lang_v1.received'), 
                'pending' => __('lang_v1.pending'), 
                'ordered' => __('lang_v1.qc_checked')];
    }

    public function orderStatusesFilter()
    {
        return [ 'received' => __('lang_v1.received'), 
                'pending' => __('lang_v1.pending'), 
                'qc_checked' => __('lang_v1.qc_checked'), 
                'qc_approved' => __('lang_v1.qc_approved')];
    }

    public function PurchaseStatusesModal()
    {
        return [ 'received' => __('lang_v1.received'), 
                'pending' => __('lang_v1.pending')];
    }
    
    public function addPurchaseOrderStatus(){
        return [ 'pending' => __('lang_v1.pending')];
    }
