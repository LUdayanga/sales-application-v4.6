...
class ContactController extends Controller
{
    ...
    private function indexSupplier()
    {
        ...
        return Datatables::of($contact)
            ...
            ->editColumn('current_opening_balance', function ($row) {
                $html = '<span class="display_currency" data-currency_symbol="true" data-orig-value="' . ($row->opening_balance - $row->opening_balance_paid) . '">' . ($row->opening_balance - $row->opening_balance_paid) . '</span>';
            ...
            ->rawColumns(['action', 'opening_balance', 'pay_term', 'due', 'return_due', 'name', 'balance' ,'current_opening_balance'])
            ->make(true);
    }
    ...
    private function indexCustomer()
    {
        ...
        return $contacts->rawColumns(['action', 'opening_balance', 'credit_limit', 'pay_term', 'due', 'return_due', 'name', 'balance' ,'current_opening_balance'])
                        ->make(true);
    }
