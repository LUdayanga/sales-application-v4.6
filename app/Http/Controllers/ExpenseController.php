    ...
    */
    ...
    public function create()
    {
        ...
        return view('expense.create')
            ->with(compact('expense_categories', 'business_locations', 'users', 'taxes', 'payment_line', 'payment_types', 'accounts', 'bl_attributes', 'contacts', 'system_currencies', 'default_currency_rate'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('expense.edit')
            ->with(compact('expense', 'expense_categories', 'business_locations', 'users', 'taxes', 'contacts', 'system_currencies', 'default_currency_rate'));
    }
