<tr>
	<td>
		...
		<input type="hidden" name="ingredients[{{$row_index}}][ingredient_type]" class="ingredient_id" value="{{$ingredient->ingredient_type ?? $type}}">
	...
	<td><button id="raw" type="button" class="btn btn-danger btn-xs remove_ingredient"><i class="fas fa-times"></i></button></td>
</tr>