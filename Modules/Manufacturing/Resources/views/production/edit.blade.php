            ...
            <div class="row">
                                    ...
                                    <select name="sub_unit_id" class="form-control" id="sub_unit_id">
                                        @foreach ($sub_units as $key => $value)
                                            <option value="{{ $key }}" data-multiplier="{{ $value['multiplier'] }}"
                                                ...
                                                @if ($key == $sub_unit_id) @php
												$unit_name = $value['name']; @endphp
                                                selected @endif
                                                >{{ $value['name'] }}</option>
                                        @endforeach
                                    </select>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        {!! Form::text('doc_index', $production_purchase->doc_index, ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        {!! Form::label('issue_no', __('manufacturing::lang.issue_no') . ':') !!}
                        {!! Form::text('issue_no', $production_purchase->issue_no, ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        {!! Form::label('section_id', __('manufacturing::lang.section') . ':*') !!}
                        {!! Form::select('section_id', $business_locations, $production_purchase->section_id, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']) !!}
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        {!! Form::label('contact_id', __('manufacturing::lang.client_name') . ':*') !!}
                        {!! Form::select('contact_id', $customers, $production_purchase->contact_id, ['class' => 'form-control select2', 'required']) !!}
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        {!! Form::label('shipment_no', __('manufacturing::lang.shipment_no') . ':') !!}
                        {!! Form::text('shipment_no', $production_purchase->shipment_no, ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        {!! Form::label('target_qty', __('manufacturing::lang.target_qty') . ':') !!}
                        {!! Form::text('target_qty', $production_purchase->target_qty, ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        {!! Form::label('day_production_qty', __('manufacturing::lang.day_production_qty') . ':') !!}
                        {!! Form::text('day_production_qty', $production_purchase->day_production_qty, ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        {!! Form::label('no_workers', __('manufacturing::lang.no_workers') . ':') !!}
                        {!! Form::text('no_workers', $production_purchase->no_workers, ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        {!! Form::label('production_duration', __('manufacturing::lang.production_duration') . ':') !!}
                        {!! Form::text('production_duration', $production_purchase->production_duration, ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('expire_date', @format_datetime($production_purchase->expire_date), ['class' => 'form-control', 'readonly', 'required']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        {!! Form::text('recovery', $production_purchase->recovery, ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="col-sm-9">
                    <div class="form-group">
                        {!! Form::label('packing_instructions', __('manufacturing::lang.packing_instruction') . ':') !!}
                        {!! Form::textarea('packing_instructions', $production_purchase->packing_instructions, ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        {!! Form::label('production_machines', __('Select Machine(s)') . ':') !!}
                        {!! Form::select('production_machines[]', $get_all_machines, $machines->pluck('machine_id'), ['class' => 'form-control select2', 'multiple', 'id' => 'production_machines']) !!}
                    </div>
                </div>
            </div>
        @endcomponent
            ...
            <div class="row">
                <div class="col-md-12">
                    <div id="enter_ingredients_table">
                        @include(
                            'manufacturing::recipe.ingredients_for_production'
                        )
                    </div>
                </div>
            </div>
                ...
                @if (request()->session()->get('business.enable_lot_number') == 1)
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('lot_number', $purchase_line->lot_number, ['class' => 'form-control', 'required',  'readonly']) !!}
                        </div>
                    </div>
                @endif
                    ...
                    <div class="form-group">
                        ...
                        <p><strong>
                            ...
                            <span id="total_production_cost" class="display_currency"
                                data-currency_symbol="true">{{ $total_production_cost }}</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-3 col-md-offset-9">
                    <div class="form-group">
                        ...
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('approve', 1, $production_purchase->is_approved, ['class' => 'input-icheck', 'id' => 'approve']) !!} @lang('Approve job card')
                            </label>
                        </div>
                        @endif
                    </div>
                    <div class="form-group">
                        @if (auth()->user()->can('manufacturing.finalize_job_card'))
                        <div class="checkbox">
                            <label>
