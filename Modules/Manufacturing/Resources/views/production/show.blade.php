            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    @if(request()->session()->get('business.enable_lot_number') == 1)
                        <br><strong>@lang('Badge No'):</strong>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <table class="table">
                        <thead>
                            <tr>
                                <th class="text-center">@lang('manufacturing::lang.ingredient')</th>
                                <th class="text-center">@lang('Lot No')</th>
                                <th class="text-center">@lang('manufacturing::lang.input_quantity')</th>
                                <th class="text-center">@lang('manufacturing::lang.waste_percent')</th>
                                <th class="text-center">@lang('manufacturing::lang.final_quantity')</th>
                                <th class="text-center">@lang('manufacturing::lang.total_price')</th>
                            </tr>
                        </thead>
                        <tbody>
                            @php
                            ...
                            @foreach($ingredients as $ingredient)
                                <tr>
                                    ...
                                    <td>{{$ingredient['tr_sell_lot_number']}}</td>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="5" class="text-right"><strong>@lang('manufacturing::lang.ingredients_cost')</strong></td>
                                <td><span class="display_currency" data-currency_symbol="true">{{$total_ingredient_price}}</span></td>
                            </tr>
                            <tr>
                                <td colspan="5" class="text-right"><strong>{{__('manufacturing::lang.production_cost')}}:</strong></td>
                                <td><span class="display_currency" data-currency_symbol="true">{{$total_production_cost}}</span> </td>
                            </tr>
                            <tr><td colspan="5" class="text-right"><strong>{{__('manufacturing::lang.total_cost')}}:</strong></td>
